...
{
    public partial class GlobalTable_Interface_Frame : Form
    {
        public MainFrame OriginFrame;
        ChangeGlobalTableData action;
        GlobalInformation_Access_Syncronized GI_Access;
        public GlobalTable_Interface_Frame(MainFrame OriginFrame, string mode)
        {
            InitializeComponent();
        ...
        {
            GlobalTable_Interface_Frame CurFrame;
            public AddInformation(GlobalTable_Interface_Frame CurFrame)
            {
        ...
        {
            GlobalTable_Interface_Frame CurFrame;
            public RemoveInformation(GlobalTable_Interface_Frame CurFrame)
            {
                this.CurFrame = CurFrame;
